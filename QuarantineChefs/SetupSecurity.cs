...
namespace QuarantineChefs
{
    public static class SetupSecurity
    {
        ...
        {
            IdentityUser admin = userManager.FindByEmailAsync("admin@quarantinechefs.com").Result;

            if (admin == null)
            {
                IdentityUser sysadmin = new IdentityUser();
                sysadmin.Email = "admin@quarantinechefs.com";
                sysadmin.UserName = "admin@quarantinechefs.com";
